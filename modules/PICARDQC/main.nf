process PICARDQC {
    ...
    bash nextflow-bin/nextflow_code.sh $fasta_index $bedfile ${bam[0]} ${bam[1]} $run_CollectMultipleMetrics $run_CollectHsMetrics $run_CollectTargetedPcrMetrics $run_CollectRnaSeqMetrics $ref_annot_refflat_path
    """
